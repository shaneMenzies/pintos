...
C_FLAGS := -I$(INCLUDE_DIR) -I$(INCLUDE_DIR)/acpi -ffreestanding -fno-isolate-erroneous-paths-attribute -nostdlib -z max-page-size=0x1000 -mno-red-zone -O2 -Wall -Wextra -g
x64_FLAGS := -m64 -mcmodel=large
CXX_FLAGS := $(C_FLAGS) -fno-exceptions -fno-rtti
LD_FLAGS := -O2 -nostdlib -lgcc -g -Xlinker -Map=kernel.map
