...
// Used by __invoke_impl instead of std_k::forward<_Tp> so that a
...
constexpr _Res __invoke_impl(__invoke_other, _Fn&& __f, _Args&&... __args) {
    return std_k::forward<_Fn>(__f)(std_k::forward<_Args>(__args)...);
}

template<typename _Res, typename _MemFun, typename _Tp, typename... _Args>
constexpr _Res __invoke_impl(__invoke_memfun_ref, _MemFun&& __f, _Tp&& __t,
                             _Args&&... __args) {
    return (__invfwd<_Tp>(__t).*__f)(std_k::forward<_Args>(__args)...);
}

template<typename _Res, typename _MemFun, typename _Tp, typename... _Args>
constexpr _Res __invoke_impl(__invoke_memfun_deref, _MemFun&& __f, _Tp&& __t,
                             _Args&&... __args) {
    return ((*std_k::forward<_Tp>(__t)).*__f)(std_k::forward<_Args>(__args)...);
}
...
constexpr _Res __invoke_impl(__invoke_memobj_deref, _MemPtr&& __f, _Tp&& __t) {
    return (*std_k::forward<_Tp>(__t)).*__f;
}
...
constexpr typename __invoke_result<_Callable, _Args...>::type
    ...
    return std_k::__invoke_impl<__type>(__tag {},
                                        std_k::forward<_Callable>(__fn),
...
constexpr enable_if_t<is_invocable_r_v<_Res, _Callable, _Args...>, _Res>
    ...
    if constexpr (is_void_v<_Res>)
        std_k::__invoke_impl<__type>(__tag {}, std_k::forward<_Callable>(__fn),
                                     std_k::forward<_Args>(__args)...);
    else
        return std_k::__invoke_impl<__type>(__tag {},
                                            std_k::forward<_Callable>(__fn),
