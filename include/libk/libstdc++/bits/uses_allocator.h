...
// This is used for std_k::experimental::erased_type from Library Fundamentals.
...
constexpr inline __uses_alloc_t<_Tp, _Alloc, _Args...>
    ...
    __ret._M_a = std_k::__addressof(__a);
    return __ret;
}
...
template<template<typename...> class _Predicate, typename _Tp, typename _Alloc,
         typename... _Args>
...
void __uses_allocator_construct_impl(__uses_alloc0 __a, _Tp* __ptr,
                                     _Args&&... __args) {
    ::new ((void*)__ptr) _Tp(std_k::forward<_Args>(__args)...);
}
...
void __uses_allocator_construct_impl(__uses_alloc1<_Alloc> __a, _Tp* __ptr,
                                     _Args&&... __args) {
    ::new ((void*)__ptr)
        _Tp(allocator_arg, *__a._M_a, std_k::forward<_Args>(__args)...);
}

template<typename _Tp, typename _Alloc, typename... _Args>
void __uses_allocator_construct_impl(__uses_alloc2<_Alloc> __a, _Tp* __ptr,
                                     _Args&&... __args) {
    ::new ((void*)__ptr) _Tp(std_k::forward<_Args>(__args)..., *__a._M_a);
}

template<typename _Tp, typename _Alloc, typename... _Args>
void __uses_allocator_construct(const _Alloc& __a, _Tp* __ptr,
                                _Args&&... __args) {
    std_k::__uses_allocator_construct_impl(
        std_k::__use_alloc<_Tp, _Alloc, _Args...>(__a), __ptr,
        std_k::forward<_Args>(__args)...);
}
