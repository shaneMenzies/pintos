...
constexpr size_t __find_uniq_type_in_pack() {
    ...
    return __n;
        ...
        // but we we define them here, to be available in <array>, <utility> and
        // <ranges> too. _GLIBCXX_RESOLVE_LIB_DEFECTS 3378.
        // tuple_size_v/tuple_element_t should be available when
